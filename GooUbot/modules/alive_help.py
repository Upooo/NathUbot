...
async def user_help_inline(client, inline_query):
    modules = loadModule()
    for mod in modules:
        imported_module = importlib.import_module(f"GooUbot.modules.{mod}")
...
<blockquote><b>powered by : @goofounder</b></blockquote>
"""
...
"""
    ...
    if mod_match:
        ...
        await callback_query.edit_message_text(
            text=text 
            + '\n<blockquote><u><b>powered by : @goofounder</b></u></blockquote>',
            reply_markup=InlineKeyboardMarkup(button),
